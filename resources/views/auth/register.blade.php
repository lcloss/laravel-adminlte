        ...
        <div class="card-body register-card-body">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Full name" id="name" name="name" value="{{ old('name') }}">
                    ...
                    @error('name')
                    <span id="nameMsgError" class="error invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Retype password" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        @error('terms')
                        <span id="termsMsgError" class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <!-- /.col -->
                    <div class="col-4">
